...
var DatePicker = /** @class */ (function (_super) {
    ...
    function DatePicker() {
        ...
        _this.state = {
            ...
            openView: _this.props.openTo || _this.props.openToYearSelection
                ? 'year'
    ...
    DatePicker.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(PickerToolbar_1.default, { className: clsx_1.default((_a = {}, _a[classes.toolbarCenter] = this.isYearOnly, _a)) },
                ...
                !this.isYearOnly &&
                    !this.isYearAndMonth && (React.createElement(ToolbarButton_1.default, { variant: "h4", onClick: this.openCalendar, selected: openView === 'day', label: utils.getDatePickerHeaderText(this.date) })),
            ...
            this.props.children,
            openView === 'year' && (React.createElement(YearSelection_1.default, { date: this.date, onChange: this.handleYearSelect, minDate: this.minDate, maxDate: this.maxDate, disablePast: disablePast, disableFuture: disableFuture, animateYearScrolling: animateYearScrolling })),
