...
declare const _default: React.ComponentType<Pick<Pick<YearSelectionProps, "onChange" | "date" | "classes" | "maxDate" | "minDate" | "disablePast" | "disableFuture" | "animateYearScrolling"> & {
